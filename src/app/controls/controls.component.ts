...
submitted = false;
  ngOnInit() {
    ...
    this.loginService.getControls().subscribe(
      res => {
  ...
  // formData.append('about', this.signupData.about);
      ...
      this.loginService.addControl(formData).subscribe((result) => {
        this.ngxService.stop();
        this.toastr.success('Control added succesfully.');
  ...
  update(){
      ...
      formData.append('feature8', this.infos.feature8);
       ...
       this.loginService.updateControl(formData,this.userId).subscribe((result) => {
        this.router.navigateByUrl('admin/dashboard', {skipLocationChange: true}).then(()=>
        this.router.navigate(["admin/controls"]));
        this.ngxService.stop();
      ...
      confirmDelete(){
        this.ngxService.start();
        this.loginService.deleteControl(this.id).subscribe(
          res => {
            this.router.navigateByUrl('admin/dashboard', {skipLocationChange: true}).then(()=>
            this.router.navigate(["admin/controls"]));

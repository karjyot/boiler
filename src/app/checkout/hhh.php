...
// 		]);
	    ...
	    $txtAdmin = $mail->sendConfirmationAdmin($boilerName,$boilerAbout,$boilerTitle,$boilerImage,$boilerPrice,$installDate,$videoDate,$logoUrl,$finalPrice,$controls['name'],$controls['title'],$controls['price'],$controls['image'],$addressInstall,$fullPostal,$personal,$product,$contact);
